    ...
    <div>
      ...
      <div className='text-sm space-y-8 flex flex-col items-center'>
        <div className='md:space-x-10 space-x-5'>
          ...
          <Link to="/course" className='hover:font-semibold'>Doctors</Link>
        ...
        <div>
          <p className='mb-8 text-balance text-center px-5'>Copyright © 2025 - All right reserved by MEDAI Industries Ltd.</p>
        </div>
      </div>
    </div>
  )
